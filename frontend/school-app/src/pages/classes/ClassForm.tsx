...
// // // // // import { userApi } from '../../api/userApi'; // assuming you have a userApi for fetching teachers
...
// // // //       try {
// // // //         const res = await userApi.getByRole('TEACHER', 0, 100); // adjust as needed
...
// // // //       setValue('classTeacherId', res.data.classTeacher?.id);
// // // //     } catch (error) {
...
// // // //   const onSubmit = async (data: ClassCreateRequest) => {
// // // //     try {
// // // //       if (id) {
// // // //         await classService.update(parseInt(id), data as ClassUpdateRequest);
// // // //       } else {
...
// // // //       <h2 className="text-2xl font-bold mb-6">{id ? 'Edit Class' : 'Create New Class'}</h2>
...
// // // //         <div>
// // // //           <label htmlFor="classTeacherId" className="block text-sm font-medium text-gray-700">
...
// // // // // src/components/classes/AddClass.tsx
// // // // // import React, { useEffect, useState } from 'react';
...
// // // // //     try {
// // // // //       await classService.create(data);
// // // // //       navigate('/classes'); // redirect to class list after creation
// // // // //     } catch (error) {
...
// // //               {/* Class Teacher */}
// // //               <div>
// // //                 <label htmlFor="classTeacherId" className="block text-sm font-medium text-gray-700 mb-1">
// // //                   Class Teacher (optional)
// // //                 </label>
// // //                 <select
// // //                   id="classTeacherId"
...
// //   // Register the field with react-hook-form (it's a number field)
// //   // We'll set its value manually via setValue
...
// //       // If there's a teacher, set the search input to teacher's name
// //       if (teacherId) {
...
// //   // Update filtered teachers when search or teachers change
// //   useEffect(() => {
...
// //     setTeacherOpen(true);
// //     // If the user types and it doesn't match the previously selected teacher's name, clear the selection
// //     const currentTeacher = teachers.find(t => t.id === (teacherIdRef as any)?.value);
// //     if (currentTeacher) {
...
// //                     disabled={fetchingTeachers}
// //                   />
// //                   {/* Hidden input for react-hook-form to hold the teacher ID */}
// //                   <input
// //                     type="hidden"
// //                     {...teacherIdRegister}
// //                     ref={teacherIdRef}
